...
class UsersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.users.index')->with('flash.success', 'Usuário salvo com sucesso');
    }
    ...
    public function destroy(User $user)
    {
        ...
        return redirect()->route('admin.users.index')->with('flash.success', 'Usuário excluído com sucesso');
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        return redirect()->route('admin.users.profile')->with('flash.success', 'Perfil salvo com sucesso');
    }
    ...
    public function block(User $user) {
        ...
        return redirect()->route('admin.users.index')->with('flash.success', 'Usuário bloqueado com sucesso');
    }
    ...
    public function unblock(User $user) {
        ...
        return redirect()->route('admin.users.index')->with('flash.success', 'Usuário desbloqueado com sucesso');
    }
}
