      ...
      <div class="container">
        <div class="row justify-content-end mt-4">
          <div class="col-lg-10 pt-4 mt-4 text-right">
            <h1 class="text-uppercase font-weight-light mt-4 pt-3 text-color-primary">Editais</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="container">
      ...
      <div class="row pt-2">
        <div class="col-lg-3">
          <aside class="sidebar">
            ...
            <ul class="nav nav-list flex-column mb-4 show-bg-active">
              ...
              <li class="nav-item"><a class="nav-link active" href="editais">Editais</a></li>
        ...
        <div class="col-lg-9">
         ...
         @foreach($editais as $ano => $editais)
         <div class="row mt-4">
          <div class="col">
            <div class="feature-box feature-box-style-2 align-items-start mb-4 ml-lg-5 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="0">
              <div class="feature-box-icon w-auto h-auto top-0">
                <img src="img/demos/construction/icons/1.png" alt="" class="img-fluid" />
              </div>
              <div class="feature-box-info ml-2">
                <h4 class="mb-2">Edital de licitação {{$ano}}</h4>
                @foreach($editais as $edital)
                <p><a href="files/editais/{{$edital->id}}.pdf" download="{{Str::slug($edital->title,'-')}}">{{$edital->title}}</a></p>
                @endforeach
