      ...
      <div class="container">
        <div class="row justify-content-end mt-4">
          <div class="col-lg-10 pt-4 mt-4 text-right">
            <h1 class="text-uppercase font-weight-light mt-4 pt-3 text-color-primary">Leis</h1>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="container">
      ...
      <div class="row pt-2">
        <div class="col-lg-3">
          <aside class="sidebar">
            ...
            <ul class="nav nav-list flex-column mb-4 show-bg-active">
              ...
              <li class="nav-item"><a class="nav-link active" href="leis">Leis</a></li>
              ...
              <li class="nav-item"><a class="nav-link" href="transparencia">Superintendência</a></li>
        ...
        <div class="col-lg-9">
          ...
          <div class="col-lg-9">
            @foreach($leis->reverse() as $ano => $leis)
            <div class="row mt-4">
              <div class="col">
                <div class="feature-box feature-box-style-2 align-items-start mb-4 ml-lg-5 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="0">
                  ...
                  <div class="feature-box-info ml-2">
                    <h4 class="mb-2">Leis de {{$ano}}</h4>
                    @foreach($leis as $lei)
                    <p><a href="files/leis/{{$lei->id}}.pdf" download="{{Str::slug($lei->title,'-')}}">{{$lei->title}}</a></p>
                    @endforeach
