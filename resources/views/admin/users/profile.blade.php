...
@section('content')
    {{ Form::model($user, ['id' => 'profile-form', 'url' => route('admin.users.save-profile'), 'files' => true]) }}
        ...
        $('#profile-form').validate({
            rules: {
                ...
                'email': {
                    ...
                    'email': true,
                    'remote': {
                        url: '{{ route('admin.users.check-profile-email') }}',
                        type: 'post',
                        data: {
                            _token: '{{ csrf_token() }}'
                        }
                ...
                'old_password': {
                    'remote': {
                        ...
                        param: {
                            url: '{{ route('admin.users.check-profile-password') }}',
                            type: 'post',
                            data: {
                                _token: '{{ csrf_token() }}'
                            }
